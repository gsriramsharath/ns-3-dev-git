...
(LEDBAT), TCP Low Priority (TCP-LP) and Data Center TCP (DCTCP) also supported.
The model also supports Selective Acknowledgements (SACK) and Explicit Congestion Notification (ECN).
