...
void
ProbChange (Ptr<OutputStreamWrapper> stream,double oldP, double newP)
{
  *stream->GetStream () << Simulator::Now ().GetSeconds () << " " << newP << std::endl;
}
...
int main (int argc, char *argv[])
{
  ...
  cmd.Parse (argc,argv);
  queue_disc_type ="FqCoDelQueueDisc";
  uv->SetStream (stream);
...
/*  Config::SetDefault ("ns3::PiQueueDisc::UseEcn", BooleanValue (useEcn));
  ...
  for (uint32_t i = 0; i < m_switchDevices.size (); i++)
    {
      ...
      Simulator::ScheduleNow (&CheckQueueSize, qdTrunk.Get (i),stream);
       Ptr<OutputStreamWrapper> stream1 = asciiTraceHelper.CreateFileStream (dir + "ProbTraces/Prob-R-" + std::to_string (i + 1) + ".plotme");
       int j;
       j=(i==0)?0:1;
      Simulator::Schedule (Seconds (1.0), &TraceProb,i,j, MakeBoundCallback (&ProbChange, stream1));
  ...
  //Config Parameters for Fq-Codel

  //T1-Scorp
   Config::Set ("/$ns3::NodeListPriv/NodeList/0/$ns3::Node/$ns3::TrafficControlLayer/RootQueueDiscList/0/$ns3::FqCoDelQueueDisc/Target", StringValue ("0.06ms"));
//Scorp-T2  G1
  Config::Set ("/$ns3::NodeListPriv/NodeList/1/$ns3::Node/$ns3::TrafficControlLayer/RootQueueDiscList/1/$ns3::FqCoDelQueueDisc/Target", StringValue ("0.06ms"));
//T2-switch1  G2
  Config::Set ("/$ns3::NodeListPriv/NodeList/2/$ns3::Node/$ns3::TrafficControlLayer/RootQueueDiscList/1/$ns3::FqCoDelQueueDisc/Target", StringValue ("0.6ms"));
//switch1-switch2  G3
  Config::Set ("/$ns3::NodeListPriv/NodeList/3/$ns3::Node/$ns3::TrafficControlLayer/RootQueueDiscList/1/$ns3::FqCoDelQueueDisc/Target", StringValue ("5ms"));
//switch3-switch4  G5
  Config::Set ("/$ns3::NodeListPriv/NodeList/5/$ns3::Node/$ns3::TrafficControlLayer/RootQueueDiscList/1/$ns3::FqCoDelQueueDisc/Target", StringValue ("5ms"));
//switch3-switch4  G5
  Config::Set ("/$ns3::NodeListPriv/NodeList/5/$ns3::Node/$ns3::TrafficControlLayer/RootQueueDiscList/1/$ns3::FqCoDelQueueDisc/Target", StringValue ("5ms"));
//switch4-switch5  G6
  Config::Set ("/$ns3::NodeListPriv/NodeList/6/$ns3::Node/$ns3::TrafficControlLayer/RootQueueDiscList/1/$ns3::FqCoDelQueueDisc/Target", StringValue ("5ms"));
//switch5-switch6  G7
  Config::Set ("/$ns3::NodeListPriv/NodeList/7/$ns3::Node/$ns3::TrafficControlLayer/RootQueueDiscList/1/$ns3::FqCoDelQueueDisc/Target", StringValue ("5ms"));
//switch6-RB G8---RB
  Config::Set ("/$ns3::NodeListPriv/NodeList/8/$ns3::Node/$ns3::TrafficControlLayer/RootQueueDiscList/2/$ns3::FqCoDelQueueDisc/Target", StringValue ("5ms"));

// T2 - S2 (10 Links)  G2---R2
  for (int i = 0,j = 12; i < 10; i++,j++)
    {
      Config::Set ("/$ns3::NodeListPriv/NodeList/2/$ns3::Node/$ns3::TrafficControlLayer/RootQueueDiscList/"+std::to_string (j)+"/$ns3::FqCoDelQueueDisc/Target", StringValue ("0.6ms"));
    }

//Switch 1 - S1   G3--R1 
  Config::Set ("/$ns3::NodeListPriv/NodeList/3/$ns3::Node/$ns3::TrafficControlLayer/RootQueueDiscList/3/$ns3::FqCoDelQueueDisc/Target", StringValue ("0.6ms"));

//Switch 1 - S3   G3--R3
  Config::Set ("/$ns3::NodeListPriv/NodeList/3/$ns3::Node/$ns3::TrafficControlLayer/RootQueueDiscList/2/$ns3::FqCoDelQueueDisc/Target", StringValue ("0.6ms"));
...
//T1-scorp G0
  ...
  Config::Set ("/$ns3::NodeListPriv/NodeList/0/$ns3::Node/$ns3::TrafficControlLayer/RootQueueDiscList/0/$ns3::PiQueueDisc/A", DoubleValue (
0.000003512335848));
  Config::Set ("/$ns3::NodeListPriv/NodeList/0/$ns3::Node/$ns3::TrafficControlLayer/RootQueueDiscList/0/$ns3::PiQueueDisc/B", DoubleValue (0.00000332651982));
...
//Scorp-T2  G1
  ...
  Config::Set ("/$ns3::NodeListPriv/NodeList/1/$ns3::Node/$ns3::TrafficControlLayer/RootQueueDiscList/1/$ns3::PiQueueDisc/A", DoubleValue (0.000003512335848));
  Config::Set ("/$ns3::NodeListPriv/NodeList/1/$ns3::Node/$ns3::TrafficControlLayer/RootQueueDiscList/1/$ns3::PiQueueDisc/B", DoubleValue (0.00000332651982));
...
//T2-switch1  G2
  ...
  Config::Set ("/$ns3::NodeListPriv/NodeList/2/$ns3::Node/$ns3::TrafficControlLayer/RootQueueDiscList/1/$ns3::PiQueueDisc/A", DoubleValue ( 0.0004348507972));
  Config::Set ("/$ns3::NodeListPriv/NodeList/2/$ns3::Node/$ns3::TrafficControlLayer/RootQueueDiscList/1/$ns3::PiQueueDisc/B", DoubleValue (0.0002490347695));
...
//switch1-switch2  G3
  ...
  Config::Set ("/$ns3::NodeListPriv/NodeList/3/$ns3::Node/$ns3::TrafficControlLayer/RootQueueDiscList/1/$ns3::PiQueueDisc/A", DoubleValue (0.0000236536583));
  Config::Set ("/$ns3::NodeListPriv/NodeList/3/$ns3::Node/$ns3::TrafficControlLayer/RootQueueDiscList/1/$ns3::PiQueueDisc/B", DoubleValue (0.00002352103321));
...
//switch2-switch3  G4
  ...
  Config::Set ("/$ns3::NodeListPriv/NodeList/4/$ns3::Node/$ns3::TrafficControlLayer/RootQueueDiscList/1/$ns3::PiQueueDisc/A", DoubleValue (0.0001709747702));
  Config::Set ("/$ns3::NodeListPriv/NodeList/4/$ns3::Node/$ns3::TrafficControlLayer/RootQueueDiscList/1/$ns3::PiQueueDisc/B", DoubleValue (0.0001686830086));
  Config::Set ("/$ns3::NodeListPriv/NodeList/4/$ns3::Node/$ns3::TrafficControlLayer/RootQueueDiscList/1/$ns3::PiQueueDisc/W", DoubleValue (400));
...
//switch3-switch4  G5
  ...
  Config::Set ("/$ns3::NodeListPriv/NodeList/5/$ns3::Node/$ns3::TrafficControlLayer/RootQueueDiscList/1/$ns3::PiQueueDisc/A", DoubleValue (0.00001772781012));
  Config::Set ("/$ns3::NodeListPriv/NodeList/5/$ns3::Node/$ns3::TrafficControlLayer/RootQueueDiscList/1/$ns3::PiQueueDisc/B", DoubleValue (0.00001765320851));
  Config::Set ("/$ns3::NodeListPriv/NodeList/5/$ns3::Node/$ns3::TrafficControlLayer/RootQueueDiscList/1/$ns3::PiQueueDisc/W", DoubleValue (400));
...
//switch4-switch5  G6
  ...
  Config::Set ("/$ns3::NodeListPriv/NodeList/6/$ns3::Node/$ns3::TrafficControlLayer/RootQueueDiscList/1/$ns3::PiQueueDisc/A", DoubleValue (0.00001891231663));
  Config::Set ("/$ns3::NodeListPriv/NodeList/6/$ns3::Node/$ns3::TrafficControlLayer/RootQueueDiscList/1/$ns3::PiQueueDisc/B", DoubleValue (0.00001882743657));
  Config::Set ("/$ns3::NodeListPriv/NodeList/6/$ns3::Node/$ns3::TrafficControlLayer/RootQueueDiscList/1/$ns3::PiQueueDisc/W", DoubleValue (400));
...
//switch5-switch6  G7
  ...
  Config::Set ("/$ns3::NodeListPriv/NodeList/7/$ns3::Node/$ns3::TrafficControlLayer/RootQueueDiscList/1/$ns3::PiQueueDisc/A", DoubleValue (0.00003725973393));
  Config::Set ("/$ns3::NodeListPriv/NodeList/7/$ns3::Node/$ns3::TrafficControlLayer/RootQueueDiscList/1/$ns3::PiQueueDisc/B", DoubleValue (0.00003704040519));
  Config::Set ("/$ns3::NodeListPriv/NodeList/7/$ns3::Node/$ns3::TrafficControlLayer/RootQueueDiscList/1/$ns3::PiQueueDisc/W", DoubleValue (400));
...
//switch6-RB G8---RB
  ...
  Config::Set ("/$ns3::NodeListPriv/NodeList/8/$ns3::Node/$ns3::TrafficControlLayer/RootQueueDiscList/2/$ns3::PiQueueDisc/A", DoubleValue (0.000003539593895));
  Config::Set ("/$ns3::NodeListPriv/NodeList/8/$ns3::Node/$ns3::TrafficControlLayer/RootQueueDiscList/2/$ns3::PiQueueDisc/B", DoubleValue (0.000003536609831));
  Config::Set ("/$ns3::NodeListPriv/NodeList/8/$ns3::Node/$ns3::TrafficControlLayer/RootQueueDiscList/2/$ns3::PiQueueDisc/W", DoubleValue (400));
  ...
  for (int i = 0,j = 12; i < 10; i++,j++)
    {
      ...
      Config::Set ("/$ns3::NodeListPriv/NodeList/2/$ns3::Node/$ns3::TrafficControlLayer/RootQueueDiscList/"+std::to_string (j)+"/$ns3::PiQueueDisc/A", DoubleValue ( 0.0001243040404));
      Config::Set ("/$ns3::NodeListPriv/NodeList/2/$ns3::Node/$ns3::TrafficControlLayer/RootQueueDiscList/"+std::to_string (j)+"/$ns3::PiQueueDisc/B", DoubleValue (0.0001036578151));
      Config::Set ("/$ns3::NodeListPriv/NodeList/2/$ns3::Node/$ns3::TrafficControlLayer/RootQueueDiscList/"+std::to_string (j)+"/$ns3::PiQueueDisc/W", DoubleValue (400));
    }
...
//Switch 1 - S1   G3--R1 
  ...
  Config::Set ("/$ns3::NodeListPriv/NodeList/3/$ns3::Node/$ns3::TrafficControlLayer/RootQueueDiscList/3/$ns3::PiQueueDisc/A", DoubleValue (0.00005957124206));
  Config::Set ("/$ns3::NodeListPriv/NodeList/3/$ns3::Node/$ns3::TrafficControlLayer/RootQueueDiscList/3/$ns3::PiQueueDisc/B", DoubleValue (0.00005440968573));
  Config::Set ("/$ns3::NodeListPriv/NodeList/3/$ns3::Node/$ns3::TrafficControlLayer/RootQueueDiscList/3/$ns3::PiQueueDisc/W", DoubleValue (400));
...
//Switch 1 - S3   G3--R3
  ...
  Config::Set ("/$ns3::NodeListPriv/NodeList/3/$ns3::Node/$ns3::TrafficControlLayer/RootQueueDiscList/2/$ns3::PiQueueDisc/A", DoubleValue (0.00005957124206));
  Config::Set ("/$ns3::NodeListPriv/NodeList/3/$ns3::Node/$ns3::TrafficControlLayer/RootQueueDiscList/2/$ns3::PiQueueDisc/B", DoubleValue (0.00005440968573));
  Config::Set ("/$ns3::NodeListPriv/NodeList/3/$ns3::Node/$ns3::TrafficControlLayer/RootQueueDiscList/2/$ns3::PiQueueDisc/W", DoubleValue (400));
...
//Switch 2 - S2     G4---R2
  ...
  Config::Set ("/$ns3::NodeListPriv/NodeList/4/$ns3::Node/$ns3::TrafficControlLayer/RootQueueDiscList/2/$ns3::PiQueueDisc/A", DoubleValue (0.0000002654135909));
  Config::Set ("/$ns3::NodeListPriv/NodeList/4/$ns3::Node/$ns3::TrafficControlLayer/RootQueueDiscList/2/$ns3::PiQueueDisc/B", DoubleValue (0.0000002653016885));
  Config::Set ("/$ns3::NodeListPriv/NodeList/4/$ns3::Node/$ns3::TrafficControlLayer/RootQueueDiscList/2/$ns3::PiQueueDisc/W", DoubleValue (400));
...
//Switch 3 - D  G5----RD
  ...
  Config::Set ("/$ns3::NodeListPriv/NodeList/5/$ns3::Node/$ns3::TrafficControlLayer/RootQueueDiscList/3/$ns3::PiQueueDisc/A", DoubleValue (0.000007082171855));
  Config::Set ("/$ns3::NodeListPriv/NodeList/5/$ns3::Node/$ns3::TrafficControlLayer/RootQueueDiscList/3/$ns3::PiQueueDisc/B", DoubleValue (0.000007070235597));
  Config::Set ("/$ns3::NodeListPriv/NodeList/5/$ns3::Node/$ns3::TrafficControlLayer/RootQueueDiscList/3/$ns3::PiQueueDisc/W", DoubleValue (400));
...
//Switch 4 - F      G6--RF 
  ...
  Config::Set ("/$ns3::NodeListPriv/NodeList/6/$ns3::Node/$ns3::TrafficControlLayer/RootQueueDiscList/2/$ns3::PiQueueDisc/A", DoubleValue (0.000002359397701));
  Config::Set ("/$ns3::NodeListPriv/NodeList/6/$ns3::Node/$ns3::TrafficControlLayer/RootQueueDiscList/2/$ns3::PiQueueDisc/B", DoubleValue (0.00000235807145));
  Config::Set ("/$ns3::NodeListPriv/NodeList/6/$ns3::Node/$ns3::TrafficControlLayer/RootQueueDiscList/2/$ns3::PiQueueDisc/W", DoubleValue (400));
...
//Switch 5 - S3   G7--R3
  ...
  Config::Set ("/$ns3::NodeListPriv/NodeList/7/$ns3::Node/$ns3::TrafficControlLayer/RootQueueDiscList/2/$ns3::PiQueueDisc/A", DoubleValue (0.0000001326928077));
  Config::Set ("/$ns3::NodeListPriv/NodeList/7/$ns3::Node/$ns3::TrafficControlLayer/RootQueueDiscList/2/$ns3::PiQueueDisc/B", DoubleValue (0.0000001326648321));
  Config::Set ("/$ns3::NodeListPriv/NodeList/7/$ns3::Node/$ns3::TrafficControlLayer/RootQueueDiscList/2/$ns3::PiQueueDisc/W", DoubleValue (400));
...
//Switch 5 - C   G7---RC
  ...
  Config::Set ("/$ns3::NodeListPriv/NodeList/7/$ns3::Node/$ns3::TrafficControlLayer/RootQueueDiscList/3/$ns3::PiQueueDisc/A", DoubleValue (0.000003539593895));
  Config::Set ("/$ns3::NodeListPriv/NodeList/7/$ns3::Node/$ns3::TrafficControlLayer/RootQueueDiscList/3/$ns3::PiQueueDisc/B", DoubleValue (0.000003536609831));
  Config::Set ("/$ns3::NodeListPriv/NodeList/7/$ns3::Node/$ns3::TrafficControlLayer/RootQueueDiscList/3/$ns3::PiQueueDisc/W", DoubleValue (400));
...
//Switch 6 - S1    G8----R1
  ...
  Config::Set ("/$ns3::NodeListPriv/NodeList/8/$ns3::Node/$ns3::TrafficControlLayer/RootQueueDiscList/1/$ns3::PiQueueDisc/A", DoubleValue (0.0000001326928077));
  Config::Set ("/$ns3::NodeListPriv/NodeList/8/$ns3::Node/$ns3::TrafficControlLayer/RootQueueDiscList/1/$ns3::PiQueueDisc/B", DoubleValue (0.0000001326648321));
  Config::Set ("/$ns3::NodeListPriv/NodeList/8/$ns3::Node/$ns3::TrafficControlLayer/RootQueueDiscList/1/$ns3::PiQueueDisc/W", DoubleValue (400));
...
//Switch 6 - E     G8----RE
  ...
  Config::Set ("/$ns3::NodeListPriv/NodeList/8/$ns3::Node/$ns3::TrafficControlLayer/RootQueueDiscList/3/$ns3::PiQueueDisc/A", DoubleValue (0.000007082171855));
  Config::Set ("/$ns3::NodeListPriv/NodeList/8/$ns3::Node/$ns3::TrafficControlLayer/RootQueueDiscList/3/$ns3::PiQueueDisc/B", DoubleValue (0.000007070235597));
  Config::Set ("/$ns3::NodeListPriv/NodeList/8/$ns3::Node/$ns3::TrafficControlLayer/RootQueueDiscList/3/$ns3::PiQueueDisc/W", DoubleValue (400));*/
